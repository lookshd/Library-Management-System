...
function loadTableData(checker) {
    ...
    books.forEach((book, index) => {
        ...
        if (checker === "title") {
            shouldDisplay = titleFilter && book.Title.toLowerCase().includes(titleFilter.toLowerCase());
        } else if (checker === "genre") {
            shouldDisplay = genreFilter && book.Genre.toLowerCase().includes(genreFilter.toLowerCase());
        }  
